    ...
    <main className="pt-24 pb-20 overflow-hidden bg-gradient-to-br from-[#fce4a4] via-[#f48f98] to-[#eb3f80] min-h-screen">
      ...
      <section className="px-4 max-w-7xl mx-auto py-20 text-center flex flex-col items-center justify-center">
        ...
        <ScrollReveal delay={0.4} direction="up">
          <p className="text-lg sm:text-xl md:text-2xl text-gray-900 max-w-3xl mx-auto font-medium leading-relaxed">
      ...
      <section className="py-12 sm:py-24 relative px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 sm:gap-16 items-center">
          ...
          <ScrollReveal direction="left" className="order-1 md:order-2 text-center md:text-left">
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6">Ethically Sourced, <br className="hidden sm:block"/><span className="text-[#eb3f80]">Happily Raised.</span></h2>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="glass card-premium p-4 rounded-2xl group cursor-pointer hover:-translate-y-2 active:-translate-y-1 hover:shadow-[0_0_25px_rgba(244,143,152,0.5)] active:shadow-[0_0_25px_rgba(244,143,152,0.6)] transition-all duration-300 relative overflow-hidden">
                 ...
                 <p className="text-xs sm:text-sm text-gray-700 group-hover:text-white/90 group-active:text-white/90 transition-colors font-medium">Non-GMO Feed</p>
              </div>
              <div className="glass card-premium p-4 rounded-2xl group cursor-pointer hover:-translate-y-2 active:-translate-y-1 hover:shadow-[0_0_25px_rgba(235,63,128,0.4)] active:shadow-[0_0_25px_rgba(235,63,128,0.5)] transition-all duration-300 relative overflow-hidden">
                 <div className="absolute inset-0 bg-theme-gradient opacity-0 group-hover:opacity-100 group-active:opacity-100 transition-opacity duration-300 -z-10"></div>
                 <p className="font-bold text-[#eb3f80] group-hover:text-white group-active:text-white transition-colors">Cruelty-Free</p>
                 <p className="text-xs sm:text-sm text-gray-700 group-hover:text-white/90 group-active:text-white/90 transition-colors font-medium">Ethical Milking</p>
              </div>
            </div>
          </ScrollReveal>
        </div>
      ...
      <section className="py-16 sm:py-24 bg-white/20 backdrop-blur-sm border-y border-white/40">
        <div className="max-w-7xl mx-auto text-center px-0 sm:px-4">
          <h2 className="text-3xl sm:text-4xl font-bold mb-12 sm:mb-16 text-gray-900">The Handcrafted Journey</h2>
          ...
          <div className="flex md:grid md:grid-cols-3 overflow-x-auto md:overflow-visible gap-6 px-4 pb-8 sm:pb-0 snap-x snap-mandatory hide-scrollbar">
            {[
              ...
              <ScrollReveal key={i} delay={i * 0.2} direction="up" className="min-w-[85vw] sm:min-w-0 snap-center glass card-premium p-8 rounded-[2rem] hover:-translate-y-3 active:-translate-y-2 hover:shadow-[0_0_35px_rgba(244,143,152,0.4)] active:shadow-[0_0_35px_rgba(244,143,152,0.5)] transition-all duration-500 relative group cursor-pointer bg-white/30 backdrop-blur-xl overflow-hidden shrink-0">
                ...
                <div className="w-16 h-16 bg-theme-gradient group-hover:bg-white group-active:bg-white rounded-2xl flex items-center justify-center text-white group-hover:text-[#eb3f80] group-active:text-[#eb3f80] mb-6 group-hover:scale-110 group-active:scale-110 transition-all shadow-lg mx-auto">
                  <step.icon size={32} />
                </div>
                ...
                <p className="text-gray-700 font-medium group-hover:text-white/90 group-active:text-white/90 leading-relaxed transition-colors">{step.desc}</p>
              </ScrollReveal>
            ))}
          </div>
        </div>
