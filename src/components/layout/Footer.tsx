...
export default function Footer() {
  // Safe Tailwind Gradient Strings
  const btnGradient = "bg-gradient-to-r from-blue-400 via-purple-400 to-pink-500";
  const hoverBtnGradient = "hover:bg-gradient-to-r hover:from-blue-400 hover:via-purple-400 hover:to-pink-500";
  const groupHoverBtnGradient = "group-hover:bg-gradient-to-r group-hover:from-blue-400 group-hover:via-purple-400 group-hover:to-pink-500";
  const textGradient = "bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 text-transparent bg-clip-text";
  
  // New: Hover Text Gradient string for the Explore links
  const hoverTextGradient = "group-hover:bg-gradient-to-r group-hover:from-blue-500 group-hover:via-purple-500 group-hover:to-pink-500 group-hover:text-transparent group-hover:bg-clip-text";

  return (
  
    <footer className="relative w-full border-t border-white/60 bg-gradient-to-b from-white/40 to-blue-50/60 backdrop-blur-3xl overflow-hidden mt-20 shadow-[0_-10px_40px_rgba(0,0,0,0.02)]">
      {/* --- PREMIUM TOP BORDER SHIMMER --- */}
      <div className={`absolute top-0 left-0 w-full h-[2px] ${btnGradient} opacity-80`}></div>

      {/* Background Decorative Glows (Switched to Blue/Cyan tones to enhance the icy glass look) */}
      <div className="absolute -bottom-24 -left-24 w-96 h-96 bg-blue-300/30 rounded-full blur-[100px] -z-10"></div>
      <div className="absolute -top-24 -right-24 w-96 h-96 bg-blue-200/40 rounded-full blur-[100px] -z-10"></div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-20 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-20">
          ...
          {/* Column 2: Navigation (Mapped to Pages & Hover Text Gradient) */}
          <ScrollReveal direction="up" delay={0.2}>
            ...
            <ul className="space-y-5">
              {[
                ...
                <li key={item.name}>
                  {/* Applied the group-hover text gradient to the link text */}
          ...
          <ScrollReveal direction="up" delay={0.3}>
            ...
            <ul className="space-y-6">
              ...
              <li className="flex items-start gap-4 group cursor-pointer">
                <div className={`w-10 h-10 glass rounded-xl flex items-center justify-center text-purple-500 ${groupHoverBtnGradient} group-hover:text-white transition-all shadow-md shrink-0 mt-1`}>
                  <MapPin size={18} />
                </div>
            ...
            <div className="glass p-6 rounded-[2rem] border-white/60 shadow-xl relative overflow-hidden">
               ...
               <form className="space-y-3" onSubmit={(e) => e.preventDefault()}>
                  <input 
                    ...
                    className="w-full px-5 py-3 rounded-xl bg-white/70 border border-white focus:outline-none focus:ring-2 focus:ring-purple-400 text-sm font-medium shadow-inner"
                  />
        ...
        <ScrollReveal direction="up" delay={0.5} className="pt-10 border-t border-white/60 flex flex-col md:flex-row justify-between items-center gap-6 text-sm">
          ...
          <div className="flex gap-8 font-bold text-gray-700">
            ...
            <Link href="#" className="hover:text-purple-600 transition-colors">Shipping</Link>
          </div>
        </ScrollReveal>
      </div>
    </footer>
