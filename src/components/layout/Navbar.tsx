    ...
    <nav className="fixed top-0 w-full z-50 glass border-b-0">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          {/* Desktop CTA */}
          <div className="hidden md:block">
            <Link href="#contact" className="px-5 py-2.5 rounded-full bg-white text-gray-900 font-bold shadow-sm hover:-translate-y-1 hover:shadow-[0_0_20px_rgba(244,114,182,0.4)] hover:bg-theme-gradient hover:text-white transition-all duration-500 border border-white/60">
              Get a Free Sample
            </Link>
          </div>
      ...
      {isOpen && (
        <div className="md:hidden glass absolute w-full rounded-b-3xl shadow-2xl border-b border-white/60">
